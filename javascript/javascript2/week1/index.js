...
function getShortestWord(words){
    return words.reduce((a,b)=>{return a.length <b.length ? a:b})
}
...
function countDanishLetters(str){
    ...
    arr.forEach(a=>{
switch(a){
    case 'å': danish1++; break;
    case 'ø': danish2++; break;
    case 'æ': danish3++; break;
}
    })
    return `{total: ${danish2+danish1+danish3}, æ: ${danish3}, ø: ${danish2}, å:${danish1}}`
}
//Method-2
